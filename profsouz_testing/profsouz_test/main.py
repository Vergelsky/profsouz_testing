...
def parse_python_versions(playwright: Playwright) -> None:
    data = []
            ...
            with context.new_page() as page:
                ...
                for string in table:
                    string_data = {
                        ...
                        "Download": string.locator('span.release-download a').text_content(),
                        "Release Notes": string.locator('span.release-enhancements a').text_content()
                        }
...
with sync_playwright() as playwright:
    parse_python_versions(playwright)
